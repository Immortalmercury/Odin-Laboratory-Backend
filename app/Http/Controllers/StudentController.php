...
class StudentController extends Controller
{
    public function index(Request $request)
    {
        switch ($request->method) {
            case 'upload_user_answer': return $this->upload_user_answer($request); break;
            case 'get_user_answer': return $this->get_user_answer($request); break;
            case 'get_student_discpline': return $this->get_student_discpline($request); break;
            case 'get_student_labs': return $this->get_student_labs($request); break;
            case 'disciplines_by_semester': return $this->disciplines_by_semester($request); break;
            case 'get_labs_of_current_semester': return $this->get_labs_of_current_semester($request); break;
            case 'get_current_semester': return $this->get_current_semester($request); break;
            case 'get_discipline_resources': return $this->get_discipline_resources($request); break;
            case 'get_sidebar_data': return $this->get_sidebar_data($request); break;
            case 'get_course_data': return $this->get_course_data($request); break;
            case 'remove_course_theme': return $this->remove_course_theme($request); break;
            case 'set_course_theme': return $this->set_course_theme($request); break;
            case 'get_exam_data': return $this->get_exam_data($request); break;
            case 'get_variant': return $this->get_variant($request); break;
            case 'get_teachers': return $this->get_teachers($request); break;


            //? case 'get_lab_file': return $this->get_lab_file($request); break;
            //? case 'get_resource': return $this->get_resource($request); break;
            //? case 'get_user_data': return $this->get_user_data($request); break;
            default:
                return self::error("UNDEFINED_METHOD (SC)");
                break;
        }
    }
