    ...
    public function index(Request $request)
    {
        switch ($request->method) {
            ...
            case 'create_invitations':
                return $this->create_invitations($request);
                break;
            case 'delete_invite':
                return $this->delete_invite($request);
                break;
            case 'delete_invitations':
                return $this->delete_invitations($request);
                break;
            case 'all_disciplines':
                return $this->all_disciplines($request);
                break;
            case 'create_discipline':
                return $this->create_discipline($request);
                break;

            default:
                return self::error("UNDEFINED_METHOD (AC)");
                break;
        }
    }
