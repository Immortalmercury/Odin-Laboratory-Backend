...
class TeacherController extends Controller
{
    public function index(Request $request)
    {
        switch ($request->method) {
            case 'labs_disciplines':
                return $this->labs_disciplines($request);
                break;
            case 'groups_semester':
                return $this->groups_semester($request);
                break;
            case 'get_current_semester':
                return $this->get_current_semester($request);
                break;
            case 'groups_students':
                return $this->groups_students($request);
                break;
            case 'discipline_data':
                return $this->discipline_data($request);
                break;
            case 'my_disciplines':
                return $this->my_disciplines($request);
                break;
            case 'create_theme': return $this->create_theme($request); break;
            case 'get_themes': return $this->get_themes($request); break;
            case 'confirm_theme': return $this->confirm_theme($request); break;
            case 'reset_theme': return $this->reset_theme($request); break;
            case 'decline_theme': return $this->decline_theme($request); break;
            case 'delete_theme': return $this->delete_theme($request); break;
            case 'add_teacher_to_discipline':
                return $this->add_teacher_to_discipline($request);
                break;
            case 'remove_teacher_from_discipline':
                return $this->remove_teacher_from_discipline($request);
                break;
            case 'add_group_to_discipline':
                return $this->add_group_to_discipline($request);
                break;
            case 'remove_group_from_discipline':
                return $this->remove_group_from_discipline($request);
                break;
            case 'set_discipline_exam_forms':
                return $this->set_discipline_exam_forms($request);
                break;
            case 'lab_in_group':
                return $this->lab_in_group($request);
                break;
            case 'groups':
                return $this->groups($request);
                break;
            case 'get_group_students':
                return $this->get_group_students($request);
                break;
            case 'current_disciplines':
                return $this->current_disciplines($request);
                break;
            case 'create_group':
                return $this->create_group($request);
                break;
            case 'create_students':
                return $this->create_students($request);
                break;
            case 'get_students_without_group':
                return $this->get_students_without_group($request);
                break;
            case 'get_teachers_without_such_discipline':
                return $this->get_teachers_without_such_discipline($request);
                break;
            case 'get_groups_without_such_discipline':
                return $this->get_groups_without_such_discipline($request);
                break;
            case 'add_student_to_group':
                return $this->add_student_to_group($request);
                break;
            case 'insert_lab_in_group':
                return $this->insert_lab_in_group($request);
                break;
            case 'insert_group_in_discipline':
                return $this->insert_group_in_discipline($request);
                break;
            case 'insert_student_in_group':
                return $this->insert_student_in_group($request);
                break;
            case 'insert_student_in_group':
                return $this->insert_student_in_group($request);
                break;
            case 'mark_for_lab':
                return $this->mark_for_lab($request);
                break;
            case 'delete_config':
                return $this->delete_config($request);
                break;
            case 'get_config':
            ...
            case 'create_config':
                ...
                break;
            case 'get_discipline_labs':
                return $this->get_discipline_labs($request);
                break;
            case 'upload_lab_file':
                return $this->upload_lab_file($request);
                break;
            case 'check_lab_data':
                return $this->check_lab_data($request);
                break;
            case 'delete_lab':
                return $this->delete_lab($request);
                break;
            case 'create_lab':
                return $this->create_lab($request);
                break;
            case 'delete_lab_in_group':
                return $this->delete_lab_in_group($request);
                break;
            case 'remove_student_from_group':
                return $this->remove_student_from_group($request);
                break;
            case 'delete_group':
                return $this->delete_group($request);
                break;
            case 'exam_in_groups':
                return $this->exam_in_groups($request);
                break;
            case 'insert_exam_in_discipline':
                return $this->insert_exam_in_discipline($request);
                break;
            case 'delete_lab_or_exam_from_discipline':
                return $this->delete_lab_or_exam_from_discipline($request);
                break;
            case 'get_discipline_resources':
                return $this->get_discipline_resources($request);
                break;
            case 'insert_resources':
                return $this->insert_resources($request);
                break;
            case 'delete_resources':
                return $this->delete_resources($request);
                break;
            case 'insert_resources_in_discipline':
                return $this->insert_resources_in_discipline($request);
                break;
            case 'delete_resource_from_discipline':
                return $this->delete_resource_from_discipline($request);
                break;
            case 'upload_resource':
                return $this->upload_resource($request);
                break;

            default:
                if ($request->jwt_user_role === 'admin') {
                    $otherController = new AdminController();
                    return $otherController->index($request);
                }
                return self::error("UNDEFINED_METHOD (TC)");
                break;
        }
    }
